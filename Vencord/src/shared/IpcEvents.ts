...
export const enum IpcEvents {
    ...
    // RagCord-specific surface
    RAGCORD_GET_SESSION = "RagCordGetSession",
    RAGCORD_LOGOUT = "RagCordLogout",
    RAGCORD_FETCH_NEWS = "RagCordFetchNews",
    RAGCORD_LINK_DISCORD = "RagCordLinkDiscord",
    RAGCORD_FETCH_NOTIFICATIONS = "RagCordFetchNotifications",
}
