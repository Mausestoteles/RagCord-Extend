...
RendererSettings.addGlobalChangeListener(() => {
    try {
        writeFileAtomicSync(SETTINGS_FILE, JSON.stringify(RendererSettings.plain, null, 4));
    } catch (e) {
...
NativeSettings.addGlobalChangeListener(() => {
    try {
        writeFileAtomicSync(NATIVE_SETTINGS_FILE, JSON.stringify(NativeSettings.plain, null, 4));
    } catch (e) {
